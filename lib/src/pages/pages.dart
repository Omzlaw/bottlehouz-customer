    ...
    setState(() {
      ...
      switch (tabItem) {
        ...
        case 3:
          ...
          break;
        case 4:
          widget.currentPage = FavoritesWidget(); //FavoritesWidget;
          break;
        case 5:
          widget.currentPage = MessagesWidget(
              parentScaffoldKey: widget
                  .scaffoldKey); //MessagesWidget(parentScaffoldKey: widget.scaffoldKey);
          break;
      }
    });
  }
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
              icon: new Icon(
                  widget.currentTab == 4 ? Icons.favorite : Icons.favorite_outline),
              label: '',
            ),
            BottomNavigationBarItem(
              icon: new Icon(
                  widget.currentTab == 5 ? Icons.chat : Icons.chat_outlined),
              label: '',
            ),
          ],
        ),
