...
import 'package:markets/src/controllers/paystack_controller.dart';
                        ...
                        SizedBox(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: () {
                              ...
                              //         param: _con.subTotal.toStringAsFixed(
                              //             setting
                              //                 .value?.currencyDecimalDigits)));
                              MakePayment(
                                      ctx: context,
                                      email: "email",
                                      price: int.parse(_con.subTotal.toStringAsFixed(setting.value?.currencyDecimalDigits)))
